...
export const Call = {
    ...
    async init(roomId) {
        ...
        this.roomUnsubscribe = onSnapshot(callDoc, (snapshot) => {
    ...
    async addIncomingCandidate(candidate) {
    ...
    async processCandidateQueue() {
        ...
        console.log(`Processing ${this.candidateQueue.length} queued candidates`);
    ...
    async startCall(type) {
        ...
        this.callUnsubscribes.push(unsubCall);
        ...
        const unsubCandidates = onSnapshot(answerCandidates, (snapshot) => {
            snapshot.docChanges().forEach((change) => {
                if (change.type === 'added') {
                    ...
                    this.addIncomingCandidate(candidate);
                }
            });
        });
        this.callUnsubscribes.push(unsubCandidates);
    ...
    async endCall() {
        // Clean up listeners
        this.callUnsubscribes.forEach(unsub => unsub());
